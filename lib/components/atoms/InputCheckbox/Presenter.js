...
var Presenter = function (_a) {
    var _b = _a.checkBoxClass, checkBoxClass = _b === void 0 ? "" : _b, _c = _a.checked, defaultChecked = _c === void 0 ? false : _c, className = _a.className, createRef = _a.createRef, error = _a.error, forceChecked = _a.forceChecked, item = _a.item, labelColor = _a.labelColor, labelSize = _a.labelSize, labelStyle = _a.labelStyle, labelWeight = _a.labelWeight, name = _a.name, onChange = _a.onChange, onClick = _a.onClick, style = _a.style, props = __rest(_a, ["checkBoxClass", "checked", "className", "createRef", "error", "forceChecked", "item", "labelColor", "labelSize", "labelStyle", "labelWeight", "name", "onChange", "onClick", "style"]);
    var _d = react_1.useState(defaultChecked), checked = _d[0], setChecked = _d[1];
    var handleChange = function (event) {
        if (isNil_1.default(forceChecked)) {
            setChecked(!checked);
        }
    ...
    var uuid = react_1.useMemo(function () { return uuid_1.v4(); }, []);
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsxs("label", __assign({ className: "inline-flex items-center cursor-pointer " + className, htmlFor: uuid, style: style }, props, { children: [jsx_runtime_1.jsx("input", { ref: createRef, checked: checked, className: inputClass + " " + checkBoxClass, id: uuid, name: name, onChange: handleChange, onClick: onClick, style: {
