...
var Presenter = function (_a) {
    var checked = _a.checked, className = _a.className, createRef = _a.createRef, item = _a.item, labelColor = _a.labelColor, labelSize = _a.labelSize, labelStyle = _a.labelStyle, labelWeight = _a.labelWeight, name = _a.name, onChange = _a.onChange, style = _a.style, props = __rest(_a, ["checked", "className", "createRef", "item", "labelColor", "labelSize", "labelStyle", "labelWeight", "name", "onChange", "style"]);
    return (jsx_runtime_1.jsxs("label", __assign({ className: "inline-flex items-center space-x-3 cursor-pointer " + className, style: style }, props, { children: [jsx_runtime_1.jsx("input", { ref: createRef, checked: checked, className: "w-5 h-5 bg-white border-2 border-gray-700 appearance-none cursor-pointer form-tick bg-check checked:bg-purple checked:border-transparent focus:outline-none transition duration-200 ease-out rounded-md", name: name, onChange: onChange, style: {
            ...
            jsx_runtime_1.jsx(Default_1.Text, __assign({ className: "leading-none relative", color: labelColor, size: labelSize, style: __assign({ top: 1 }, labelStyle), weight: labelWeight }, { children: item.label }), void 0)] }), void 0));
};
