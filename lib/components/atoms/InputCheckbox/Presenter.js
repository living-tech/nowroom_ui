...
var Presenter = function (_a) {
    ...
    var id = react_1.useMemo(function () { return uuid_1.v4(); }, []);
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsxs("label", __assign({ className: "inline-flex items-center cursor-pointer " + className, htmlFor: id, style: style }, props, { children: [jsx_runtime_1.jsx("input", { ref: createRef, checked: checked, className: inputClass, id: uuid_1.v4(), name: name, onChange: onChange, onClick: onClick, style: {
