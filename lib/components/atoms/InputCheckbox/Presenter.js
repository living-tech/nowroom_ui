...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs("label", __assign({ className: "inline-flex items-center space-x-3 cursor-pointer " + className, style: style }, props, { children: [jsx_runtime_1.jsx("input", { ref: createRef, checked: checked, className: "form-tick bg-check checked:bg-purple checked:border-transparent focus:outline-none w-5 h-5 transition duration-200 ease-out bg-white border-2 border-gray-700 rounded-md appearance-none", name: name, onChange: onChange, style: {
