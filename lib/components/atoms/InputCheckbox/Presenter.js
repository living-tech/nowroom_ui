...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsxs("label", __assign({ className: "inline-flex items-center cursor-pointer " + className, style: style }, props, { children: [jsx_runtime_1.jsx("input", { ref: createRef, checked: checked, className: inputClass, name: name, onChange: onChange, style: {
            ...
            error && jsx_runtime_1.jsx(Red_1.TextRed, __assign({ size: "sm" }, { children: error }), void 0)] }, void 0));
};
