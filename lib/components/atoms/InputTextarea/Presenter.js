...
var Presenter = function (_a) {
    var any = _a.any, className = _a.className, createRef = _a.createRef, defaultValue = _a.defaultValue, error = _a.error, id = _a.id, label = _a.label, name = _a.name, onChange = _a.onChange, placeholder = _a.placeholder, renderDescription = _a.renderDescription, _b = _a.resize, resize = _b === void 0 ? false : _b, rows = _a.rows, style = _a.style, _c = _a.weight, weight = _c === void 0 ? "bold" : _c, props = __rest(_a, ["any", "className", "createRef", "defaultValue", "error", "id", "label", "name", "onChange", "placeholder", "renderDescription", "resize", "rows", "style", "weight"]);
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, props, { children: [label && (jsx_runtime_1.jsxs("label", __assign({ className: "block mb-3 text-sm font-bold text-gray-700 cursor-pointer", htmlFor: id }, { children: [label, any && (jsx_runtime_1.jsx(MediumGray02_1.TextMediumGray02, __assign({ className: "ml-3", size: "sm", tag: "span" }, { children: t("任意") }), void 0))] }), void 0)),
            ...
            jsx_runtime_1.jsx("div", __assign({ className: "relative" }, { children: jsx_runtime_1.jsx("textarea", { ref: createRef, className: inputBaseClass + " " + inputClass + " " + inputResizeClass, defaultValue: defaultValue, id: id, name: name, onChange: onChange, placeholder: placeholder, rows: rows }, void 0) }), void 0),
