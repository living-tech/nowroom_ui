...
var Presenter = function (_a) {
    var _b;
    var any = _a.any, _c = _a.anyLabel, anyLabel = _c === void 0 ? "任意" : _c, _d = _a.backgroundColor, backgroundColor = _d === void 0 ? "gray" : _d, block = _a.block, className = _a.className, createRef = _a.createRef, defaultValue = _a.defaultValue, disabled = _a.disabled, _e = _a.disabledPlaceholder, disabledPlaceholder = _e === void 0 ? false : _e, _f = _a.disabledRightArrow, disabledRightArrow = _f === void 0 ? false : _f, error = _a.error, iconColor = _a.iconColor, iconName = _a.iconName, id = _a.id, items = _a.items, label = _a.label, name = _a.name, onChange = _a.onChange, _g = _a.placeholder, placeholder = _g === void 0 ? "選択してください" : _g, _h = _a.size, size = _h === void 0 ? "md" : _h, style = _a.style, value = _a.value, props = __rest(_a, ["any", "anyLabel", "backgroundColor", "block", "className", "createRef", "defaultValue", "disabled", "disabledPlaceholder", "disabledRightArrow", "error", "iconColor", "iconName", "id", "items", "label", "name", "onChange", "placeholder", "size", "style", "value"]);
    ...
    react_1.useEffect(function () {
        var _a;
        setSelectedValue((_a = value !== null && value !== void 0 ? value : defaultValue) !== null && _a !== void 0 ? _a : "");
    }, [value, defaultValue]);
    var widthClass = "";
    if (block) {
        widthClass = "w-full";
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, props, { children: [label && (jsx_runtime_1.jsxs("label", __assign({ className: "block mb-3 text-sm font-bold text-gray-700 cursor-pointer", htmlFor: id }, { children: [label, any && (jsx_runtime_1.jsx(MediumGray02_1.TextMediumGray02, __assign({ className: "ml-3", size: "sm", tag: "span" }, { children: anyLabel }), void 0))] }), void 0)),
            jsx_runtime_1.jsxs("div", __assign({ className: "relative block " + widthClass }, { children: [iconName && (jsx_runtime_1.jsx(Default_1.Icon, { className: "top-1/2 absolute transform -translate-y-1/2 pointer-events-none " + iconPositionClass, color: iconColor, name: iconName, size: "sm" }, void 0)),
                    jsx_runtime_1.jsxs("select", __assign({ ref: createRef, className: "text-base w-full cursor-pointer whitespace-nowrap block border font-bold border-gray-200 rounded-md appearance-none focus:outline-none focus:ring-primary-500 focus:border-primary-500 " + backgroundColorClass + " " + colorClass + " " + paddingLeftClass + " " + paddingRightClass + " " + paddingYClass + " " + widthClass + " " + inputClass, defaultValue: defaultValue, disabled: disabled, id: id, name: name, onChange: handleChange, value: value }, { children: [!disabledPlaceholder && jsx_runtime_1.jsx("option", __assign({ value: "" }, { children: placeholder }), void 0),
