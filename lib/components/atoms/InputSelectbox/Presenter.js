...
var Presenter = function (_a) {
    var any = _a.any, block = _a.block, className = _a.className, createRef = _a.createRef, defaultValue = _a.defaultValue, _b = _a.disabledPlaceholder, disabledPlaceholder = _b === void 0 ? false : _b, id = _a.id, items = _a.items, label = _a.label, name = _a.name, onChange = _a.onChange, placeholder = _a.placeholder, _c = _a.size, size = _c === void 0 ? "md" : _c, style = _a.style, props = __rest(_a, ["any", "block", "className", "createRef", "defaultValue", "disabledPlaceholder", "id", "items", "label", "name", "onChange", "placeholder", "size", "style"]);
