...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, props, { children: [label && (jsx_runtime_1.jsxs("label", __assign({ className: "block mb-3 text-sm font-bold text-gray-700 cursor-pointer", htmlFor: id }, { children: [label, any && (jsx_runtime_1.jsx(MediumGray02_1.TextMediumGray02, __assign({ className: "ml-3", size: "sm", tag: "span" }, { children: anyLabel }), void 0))] }), void 0)),
            ...
            jsx_runtime_1.jsxs("div", __assign({ className: "relative" }, { children: [iconName && (jsx_runtime_1.jsx(Default_1.Icon, { className: "absolute pointer-events-none", color: color === "white" ? "darkGray02" : "black", name: iconName, size: size === "md" ? "md" : "sm", style: {
                    ...
                    jsx_runtime_1.jsx("input", { ref: createRef, autoComplete: autocomplete, className: inputBaseClass + " " + inputClass + " " + roundedClass + " " + inputBackgroundColorClass + " " + inputClassName, defaultValue: defaultValue, disabled: disabled, id: id, name: name, onBlur: onBlur, onChange: onChange, onFocus: onFocus, onKeyPress: onKeyPress, placeholder: placeholder, style: inputStyle, type: type, value: value }, void 0),
