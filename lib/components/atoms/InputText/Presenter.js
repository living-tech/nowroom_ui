...
var Presenter = function (_a) {
    var any = _a.any, _b = _a.anyLabel, anyLabel = _b === void 0 ? "任意" : _b, autocomplete = _a.autocomplete, className = _a.className, _c = _a.color, color = _c === void 0 ? "gray" : _c, createRef = _a.createRef, defaultValue = _a.defaultValue, error = _a.error, iconName = _a.iconName, id = _a.id, label = _a.label, name = _a.name, onBlur = _a.onBlur, onChange = _a.onChange, onFocus = _a.onFocus, onKeyPress = _a.onKeyPress, placeholder = _a.placeholder, renderDescription = _a.renderDescription, _d = _a.size, size = _d === void 0 ? "md" : _d, style = _a.style, _e = _a.type, type = _e === void 0 ? "text" : _e, unit = _a.unit, _f = _a.unitPosition, unitPosition = _f === void 0 ? "right" : _f, value = _a.value, _g = _a.weight, weight = _g === void 0 ? "bold" : _g, props = __rest(_a, ["any", "anyLabel", "autocomplete", "className", "color", "createRef", "defaultValue", "error", "iconName", "id", "label", "name", "onBlur", "onChange", "onFocus", "onKeyPress", "placeholder", "renderDescription", "size", "style", "type", "unit", "unitPosition", "value", "weight"]);
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, props, { children: [label && (jsx_runtime_1.jsxs("label", __assign({ className: "block mb-3 text-sm font-bold text-gray-700 cursor-pointer", htmlFor: id }, { children: [label, any && (jsx_runtime_1.jsx(MediumGray02_1.TextMediumGray02, __assign({ className: "ml-3", size: "sm", tag: "span" }, { children: anyLabel }), void 0))] }), void 0)),
            ...
            jsx_runtime_1.jsxs("div", __assign({ className: "relative" }, { children: [iconName && (jsx_runtime_1.jsx(Default_1.Icon, { className: "absolute pointer-events-none", color: color === "white" ? "darkGray02" : "black", name: iconName, size: size, style: {
                    ...
                    jsx_runtime_1.jsx("input", { ref: createRef, autoComplete: autocomplete, className: inputBaseClass + " " + inputClass + " " + roundedClass + " " + inputBackgroundColorClass, defaultValue: defaultValue, id: id, name: name, onBlur: onBlur, onChange: onChange, onFocus: onFocus, onKeyPress: onKeyPress, placeholder: placeholder, type: type, value: value }, void 0),
