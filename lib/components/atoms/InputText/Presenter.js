...
var Presenter = function (_a) {
    var any = _a.any, _b = _a.anyLabel, anyLabel = _b === void 0 ? "任意" : _b, autocomplete = _a.autocomplete, _c = _a.className, className = _c === void 0 ? "" : _c, _d = _a.color, color = _d === void 0 ? "gray" : _d, createRef = _a.createRef, defaultValue = _a.defaultValue, _e = _a.disabled, disabled = _e === void 0 ? false : _e, error = _a.error, iconName = _a.iconName, id = _a.id, _f = _a.inputClassName, inputClassName = _f === void 0 ? "" : _f, inputStyle = _a.inputStyle, label = _a.label, list = _a.list, name = _a.name, onBlur = _a.onBlur, onChange = _a.onChange, onFocus = _a.onFocus, onKeyPress = _a.onKeyPress, placeholder = _a.placeholder, renderDescription = _a.renderDescription, require = _a.require, _g = _a.requireLabel, requireLabel = _g === void 0 ? "必須" : _g, _h = _a.size, size = _h === void 0 ? "md" : _h, style = _a.style, _j = _a.type, type = _j === void 0 ? "text" : _j, unit = _a.unit, _k = _a.unitPosition, unitPosition = _k === void 0 ? "right" : _k, value = _a.value, _l = _a.weight, weight = _l === void 0 ? "bold" : _l, props = __rest(_a, ["any", "anyLabel", "autocomplete", "className", "color", "createRef", "defaultValue", "disabled", "error", "iconName", "id", "inputClassName", "inputStyle", "label", "list", "name", "onBlur", "onChange", "onFocus", "onKeyPress", "placeholder", "renderDescription", "require", "requireLabel", "size", "style", "type", "unit", "unitPosition", "value", "weight"]);
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, props, { children: [label && (jsx_runtime_1.jsxs("label", __assign({ className: "block mb-3 text-sm font-bold text-gray-700 cursor-pointer", htmlFor: id }, { children: [label, any && (jsx_runtime_1.jsx(MediumGray02_1.TextMediumGray02, __assign({ className: "ml-3", size: "sm", tag: "span" }, { children: anyLabel }), void 0)),
            ...
            jsx_runtime_1.jsxs("div", __assign({ className: "relative" }, { children: [iconName && (jsx_runtime_1.jsx(Default_1.Icon, { className: "absolute pointer-events-none", color: color === "white" ? "darkGray02" : "black", name: iconName, size: size === "md" ? "md" : "sm", style: {
                    ...
                    jsx_runtime_1.jsx("input", { ref: createRef, autoComplete: autocomplete, className: inputBaseClass + " " + inputClass + " " + roundedClass + " " + inputBackgroundColorClass + " " + inputClassName + " disabled:opacity-40 disabled:cursor-not-allowed", defaultValue: defaultValue, disabled: disabled, id: id, list: list, name: name, onBlur: onBlur, onChange: onChange, onFocus: onFocus, onKeyPress: onKeyPress, placeholder: placeholder, style: inputStyle, type: type, value: value }, void 0),
