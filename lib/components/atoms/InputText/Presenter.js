...
var Presenter = function (_a) {
    var any = _a.any, _b = _a.anyLabel, anyLabel = _b === void 0 ? "任意" : _b, autocomplete = _a.autocomplete, className = _a.className, createRef = _a.createRef, defaultValue = _a.defaultValue, error = _a.error, iconName = _a.iconName, id = _a.id, label = _a.label, name = _a.name, onChange = _a.onChange, onKeyPress = _a.onKeyPress, placeholder = _a.placeholder, renderDescription = _a.renderDescription, _c = _a.size, size = _c === void 0 ? "md" : _c, style = _a.style, _d = _a.type, type = _d === void 0 ? "text" : _d, unit = _a.unit, _e = _a.unitPosition, unitPosition = _e === void 0 ? "right" : _e, value = _a.value, _f = _a.weight, weight = _f === void 0 ? "bold" : _f, props = __rest(_a, ["any", "anyLabel", "autocomplete", "className", "createRef", "defaultValue", "error", "iconName", "id", "label", "name", "onChange", "onKeyPress", "placeholder", "renderDescription", "size", "style", "type", "unit", "unitPosition", "value", "weight"]);
    var inputBaseClass = "bg-gray-100 border block w-full rounded-md placeholder-gray-400";
    var inputClass = "";
    if (error) {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, props, { children: [label && (jsx_runtime_1.jsxs("label", __assign({ className: "block mb-3 text-sm font-bold text-gray-700 cursor-pointer", htmlFor: id }, { children: [label, any && (jsx_runtime_1.jsx(MediumGray02_1.TextMediumGray02, __assign({ className: "ml-3", size: "sm", tag: "span" }, { children: anyLabel }), void 0))] }), void 0)),
            ...
            jsx_runtime_1.jsxs("div", __assign({ className: "relative" }, { children: [iconName && (jsx_runtime_1.jsx(Default_1.Icon, { className: "absolute pointer-events-none", name: iconName, size: size, style: {
                    ...
                    jsx_runtime_1.jsx("input", { ref: createRef, autoComplete: autocomplete, className: inputBaseClass + " " + inputClass, defaultValue: defaultValue, id: id, name: name, onChange: onChange, onKeyPress: onKeyPress, placeholder: placeholder, type: type, value: value }, void 0),
