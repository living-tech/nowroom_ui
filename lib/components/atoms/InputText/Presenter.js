...
var Presenter = function (_a) {
    var any = _a.any, _b = _a.anyLabel, anyLabel = _b === void 0 ? "任意" : _b, autocomplete = _a.autocomplete, _c = _a.className, className = _c === void 0 ? "" : _c, _d = _a.color, color = _d === void 0 ? "gray" : _d, createRef = _a.createRef, defaultValue = _a.defaultValue, _e = _a.disabled, disabled = _e === void 0 ? false : _e, error = _a.error, iconName = _a.iconName, id = _a.id, _f = _a.inputClassName, inputClassName = _f === void 0 ? "" : _f, inputStyle = _a.inputStyle, label = _a.label, list = _a.list, name = _a.name, onBlur = _a.onBlur, onChange = _a.onChange, onFocus = _a.onFocus, onKeyPress = _a.onKeyPress, placeholder = _a.placeholder, renderDescription = _a.renderDescription, _g = _a.require, require = _g === void 0 ? "必須" : _g, requireLabel = _a.requireLabel, _h = _a.size, size = _h === void 0 ? "md" : _h, style = _a.style, _j = _a.type, type = _j === void 0 ? "text" : _j, unit = _a.unit, _k = _a.unitPosition, unitPosition = _k === void 0 ? "right" : _k, value = _a.value, _l = _a.weight, weight = _l === void 0 ? "bold" : _l, props = __rest(_a, ["any", "anyLabel", "autocomplete", "className", "color", "createRef", "defaultValue", "disabled", "error", "iconName", "id", "inputClassName", "inputStyle", "label", "list", "name", "onBlur", "onChange", "onFocus", "onKeyPress", "placeholder", "renderDescription", "require", "requireLabel", "size", "style", "type", "unit", "unitPosition", "value", "weight"]);
