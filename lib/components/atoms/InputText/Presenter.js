...
var Presenter = function (_a) {
    var any = _a.any, autocomplete = _a.autocomplete, className = _a.className, createRef = _a.createRef, defaultValue = _a.defaultValue, error = _a.error, iconName = _a.iconName, id = _a.id, label = _a.label, name = _a.name, onChange = _a.onChange, onKeyPress = _a.onKeyPress, placeholder = _a.placeholder, renderDescription = _a.renderDescription, _b = _a.size, size = _b === void 0 ? "md" : _b, style = _a.style, _c = _a.type, type = _c === void 0 ? "text" : _c, unit = _a.unit, _d = _a.unitPosition, unitPosition = _d === void 0 ? "right" : _d, value = _a.value, _e = _a.weight, weight = _e === void 0 ? "bold" : _e, props = __rest(_a, ["any", "autocomplete", "className", "createRef", "defaultValue", "error", "iconName", "id", "label", "name", "onChange", "onKeyPress", "placeholder", "renderDescription", "size", "style", "type", "unit", "unitPosition", "value", "weight"]);
