...
var Presenter = function (_a) {
    var any = _a.any, autocomplete = _a.autocomplete, className = _a.className, createRef = _a.createRef, error = _a.error, iconName = _a.iconName, id = _a.id, label = _a.label, name = _a.name, onChange = _a.onChange, onKeyPress = _a.onKeyPress, placeholder = _a.placeholder, renderDescription = _a.renderDescription, _b = _a.size, size = _b === void 0 ? "md" : _b, style = _a.style, _c = _a.type, type = _c === void 0 ? "text" : _c, unit = _a.unit, _d = _a.unitPosition, unitPosition = _d === void 0 ? "right" : _d, value = _a.value, _e = _a.weight, weight = _e === void 0 ? "bold" : _e, props = __rest(_a, ["any", "autocomplete", "className", "createRef", "error", "iconName", "id", "label", "name", "onChange", "onKeyPress", "placeholder", "renderDescription", "size", "style", "type", "unit", "unitPosition", "value", "weight"]);
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, props, { children: [label && (jsx_runtime_1.jsxs("label", __assign({ className: "block mb-3 text-sm font-bold text-gray-700 cursor-pointer", htmlFor: id }, { children: [label, any && (jsx_runtime_1.jsx(MediumGray02_1.TextMediumGray02, __assign({ className: "ml-3", size: "sm", tag: "span" }, { children: t("任意") }), void 0))] }), void 0)),
            ...
            jsx_runtime_1.jsxs("div", __assign({ className: "relative" }, { children: [iconName && (jsx_runtime_1.jsx(Default_1.Icon, { className: "absolute pointer-events-none", name: iconName, size: size, style: {
                    ...
                    jsx_runtime_1.jsx("input", { ref: createRef, autoComplete: autocomplete, className: inputBaseClass + " " + inputClass, id: id, name: name, onChange: onChange, onKeyPress: onKeyPress, placeholder: placeholder, type: type, value: value }, void 0),
