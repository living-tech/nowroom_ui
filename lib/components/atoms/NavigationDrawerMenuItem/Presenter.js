...
exports.Presenter = react_1.forwardRef(function (_a, _ref) {
    ...
    if (item.onClick) {
        ...
        return (jsx_runtime_1.jsx(link_1.default, __assign({ passHref: true, href: item.href }, { children: jsx_runtime_1.jsx("a", __assign({ className: colorClass + " " + baseClass + " " + className, style: style }, { children: "" + item.label }), void 0) }), void 0));
    }
    else {
