...
exports.Presenter = react_1.forwardRef(function (_a, _ref) {
    ...
    if (item.onClick) {
        ...
        return (jsx_runtime_1.jsx(link_1.default, __assign({ href: item.href, prefetch: false }, { children: jsx_runtime_1.jsx(jsx_runtime_1.Fragment, { children: jsx_runtime_1.jsx("a", __assign({ className: colorClass + " " + baseClass + " " + className, style: style }, { children: item.label }), void 0) }, void 0) }), void 0));
    }
    else {
