...
exports.Presenter = react_1.forwardRef(function (_a, _ref) {
    ...
    if (item.onClick) {
        return (jsx_runtime_1.jsx("button", __assign({ className: colorClass + " " + baseClass + " " + className + " " + item.className, onClick: item.onClick, style: style, type: buttonType }, { children: item.label }), void 0));
    }
    else if (item.href) {
        return (jsx_runtime_1.jsx(link_1.default, __assign({ passHref: true, href: item.href }, { children: jsx_runtime_1.jsx("a", __assign({ className: colorClass + " " + baseClass + " " + className + " " + item.className, style: style }, { children: "" + item.label }), void 0) }), void 0));
    }
    else {
