...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: "inline-flex items-center " + className, style: style }, props, { children: [labelPosition === "left" && label && (jsx_runtime_1.jsx(Default_1.Text, __assign({ className: "mr-3", color: labelColor, size: labelSize, style: { position: "relative", top: 1 }, tag: "span", weight: labelWeight }, { children: label }), void 0)),
            jsx_runtime_1.jsx("div", __assign({ className: "relative inline-block align-middle select-none w-7 transition duration-200 ease-out" }, { children: jsx_runtime_1.jsxs("label", __assign({ className: "flex items-center block h-6 overflow-hidden cursor-pointer", htmlFor: id }, { children: [jsx_runtime_1.jsx("span", { className: "block w-full h-2 bg-purple-200 rounded-full" }, void 0),
                        jsx_runtime_1.jsx("input", { ref: createRef, checked: checked, className: "absolute block w-4 h-4 bg-white rounded-full outline-none appearance-none cursor-pointer top-2/4 -translate-y-2/4 checked:right-0 right-3 checked:bg-purple radio-button:bg-purple-200 transition-all duration-200 ease-out transform", id: id, name: name, onChange: onChange, style: {
