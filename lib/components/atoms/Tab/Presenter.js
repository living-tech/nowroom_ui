...
exports.Presenter = react_1.forwardRef(function (_a, ref) {
    ...
    return (jsx_runtime_1.jsx("li", __assign({ ref: ref, className: "hover:bg-purple-100 relative inline-block w-full pt-4 pb-3.5 pl-2 pr-2 text-center list-none transition duration-200 ease-out border-b border-gray-200 cursor-pointer", id: id, onClick: function () { return onClick && onClick(index); }, onMouseEnter: function () { return onTabMouseEnter(index); }, onMouseLeave: onTabMouseLeave, style: style }, props, { children: jsx_runtime_1.jsx(Default_1.Text, __assign({ className: "transition duration-200 ease-out " + textColorClass, size: "xs", weight: "bold" }, { children: label }), void 0) }), void 0));
});
