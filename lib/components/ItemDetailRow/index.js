...
var ItemDetailRow = function (_a) {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: "flex justify-between mt-1 " + className }, { children: [jsx_runtime_1.jsx(atoms_1.TextDarkGray02, __assign({ size: "xs" }, { children: left }), void 0),
...
var ItemDetailRowRoomType = function (_a) {
    ...
    // 0以下は赤にする。
    if (value <= 0) {
        return (jsx_runtime_1.jsx(exports.ItemDetailRow, { className: className, left: title, right: jsx_runtime_1.jsxs(atoms_1.TextRed, __assign({ size: "xs" }, { children: ["" + exports.createRoomPriceUnit(value), " "] }), void 0) }, void 0));
    }
    return jsx_runtime_1.jsx(exports.ItemDetailRow, { className: className, left: title, right: "" + exports.createRoomPriceUnit(value) }, void 0);
};
...
var createRoomPriceUnit = function (value) {
    ...
    return exports.isMonthUnit(value) ? value + "\u30F6\u6708" : "\u00A5" + value;
};
