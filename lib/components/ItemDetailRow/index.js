...
var ItemDetailRowRoomType = function (_a) {
    ...
    // 0以下は赤にする。
    if (value <= 0) {
        return (jsx_runtime_1.jsx(exports.ItemDetailRow, { className: className !== null && className !== void 0 ? className : "", left: title, right: jsx_runtime_1.jsx(atoms_1.TextRed, __assign({ size: "xs" }, { children: "" + exports.createRoomPriceUnit(value) }), void 0) }, void 0));
    }
