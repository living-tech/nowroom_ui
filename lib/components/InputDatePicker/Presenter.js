...
var Presenter = function (_a) {
    var any = _a.any, _b = _a.anyLabel, anyLabel = _b === void 0 ? "任意" : _b, _c = _a.calendarPosition, calendarPosition = _c === void 0 ? "absoluteLeft" : _c, _d = _a.calendarPositionSlide, calendarPositionSlide = _d === void 0 ? 0 : _d, className = _a.className, error = _a.error, id = _a.id, label = _a.label, _e = _a.monthLabel, monthLabel = _e === void 0 ? "月" : _e, name = _a.name, onChange = _a.onChange, onClear = _a.onClear, placeholder = _a.placeholder, require = _a.require, _f = _a.requireLabel, requireLabel = _f === void 0 ? "必須" : _f, selectableFrom = _a.selectableFrom, selectableTo = _a.selectableTo, _g = _a.size, size = _g === void 0 ? "md" : _g, style = _a.style, value = _a.value, _h = _a.weight, weight = _h === void 0 ? "bold" : _h, _j = _a.yearLabel, yearLabel = _j === void 0 ? "年" : _j;
    ...
    var _k = react_1.useState(false), isShowCalendar = _k[0], setIsShowCalendar = _k[1];
    ...
    var calendarPositionStyle = react_1.useMemo(function () {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: "relative " + className, style: style }, { children: [jsx_runtime_1.jsxs("div", { children: [label && (jsx_runtime_1.jsxs("label", __assign({ className: "block mb-3 text-sm font-bold text-gray-700 cursor-pointer", htmlFor: id }, { children: [label, any && (jsx_runtime_1.jsx(MediumGray02_1.TextMediumGray02, __assign({ className: "ml-3", size: "sm", tag: "span" }, { children: anyLabel }), void 0)),
                    ...
                    jsx_runtime_1.jsxs("div", __assign({ className: "relative" }, { children: [jsx_runtime_1.jsxs("div", __assign({ className: "relative", onClick: function () { return setIsShowCalendar(true); } }, { children: [jsx_runtime_1.jsx("input", { className: inputBaseClass + " " + inputClass, id: id, name: name, placeholder: placeholder, value: (value === null || value === void 0 ? void 0 : value.format("YYYY/M/D")) || "" }, void 0),
            ...
            jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                ...
                }, in: isShowCalendar, timeout: 400 }, { children: jsx_runtime_1.jsx(core_1.ClickAwayListener, __assign({ onClickAway: function () { return setIsShowCalendar(false); } }, { children: jsx_runtime_1.jsx("div", __assign({ className: "z-10 inline-block", style: calendarPositionStyle }, { children: jsx_runtime_1.jsx(react_datepicker_1.default, { inline: true, filterDate: function (day) { return isDaySelectable(day); }, locale: "ja", onChange: handleDateChange, renderCustomHeader: function (_a) {
