...
var Presenter = function (_a) {
    ...
    var _g = utils_1.useBreakPoints(), isDesktop = _g.isDesktop, isMobile = _g.isMobile;
    var windowWidth = window_size_1.useWindowWidth();
    var _h = react_1.useState(false), visible = _h[0], setVisible = _h[1];
    var _j = react_1.useState(0), fixedBottomHeight = _j[0], setFixedBottomHeight = _j[1];
    ...
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                    ...
                    exitActive: Modal_module_scss_1.default.ModalExitActive,
                        ...
                        setVisible(false);
                        onRequestClose && onRequestClose();
                    }, style: { zIndex: zIndex } }, props, { children: !isMobile && (jsx_runtime_1.jsxs("div", __assign({ className: "flex items-center" }, { children: [jsx_runtime_1.jsx(White_3.LabelTextWhite, { children: "ESC" }, void 0),
            ...
            jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                ...
                }, in: visible, timeout: { enter: 400, exit: 400 } }, { children: jsx_runtime_1.jsx("div", __assign({ className: "fixed top-1/2 left-1/2 " + modalSizeClass, style: {
                        maxHeight: isMobile && windowWidth <= maxWidth ? undefined : "calc(100vh - 128px)",
                        maxWidth: maxWidth,
                        minHeight: loading ? 200 : undefined,
                        zIndex: zIndex + 1,
                    } }, { children: jsx_runtime_1.jsxs("div", __assign({ className: "transition-all ease-out duration-200 py-10 md:py-8 bg-white md:rounded-lg cursor-auto shadow-xl overflow-y-auto " + modalSizeClass + " " + paddingHorizontalClass, style: {
                            maxHeight: isMobile && windowWidth <= maxWidth ? undefined : "calc(100vh - 128px)",
                            maxWidth: maxWidth,
                            minHeight: loading ? 200 : undefined,
