...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                ...
                }, in: visible, timeout: 400 }, { children: jsx_runtime_1.jsx("div", __assign({ onClick: function () {
                        setVisible(false);
                        onRequestClose && onRequestClose();
                    }, style: { zIndex: zIndex } }, __assign(__assign({}, props), { className: "fixed top-0 left-0 w-full h-full p-4 cursor-pointer bg-overlay" }), { children: !isMobile && (jsx_runtime_1.jsxs("div", __assign({ className: "flex items-center" }, { children: [jsx_runtime_1.jsx(White_3.LabelTextWhite, { children: "ESC" }, void 0),
