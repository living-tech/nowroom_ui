...
var Presenter = function (_a) {
    var children = _a.children, _b = _a.closeButtonPosition, closeButtonPosition = _b === void 0 ? "top" : _b, _c = _a.escLabel, escLabel = _c === void 0 ? "を押して閉じる" : _c, isVisible = _a.isVisible, loading = _a.loading, _d = _a.maxWidth, maxWidth = _d === void 0 ? 400 : _d, onRequestClose = _a.onRequestClose, renderFixedBottom = _a.renderFixedBottom, props = __rest(_a, ["children", "closeButtonPosition", "escLabel", "isVisible", "loading", "maxWidth", "onRequestClose", "renderFixedBottom"]);
    var _e = utils_1.useBreakPoints(), isDesktop = _e.isDesktop, isMobile = _e.isMobile;
    var _f = react_1.useState(false), visible = _f[0], setVisible = _f[1];
    var _g = react_1.useState(0), fixedBottomHeight = _g[0], setFixedBottomHeight = _g[1];
    ...
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [!isMobile && (jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
            ...
            jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                    ...
                    exitActive: Modal_module_scss_1.default.ModalInnerExitActive,
                }, in: visible, timeout: { enter: 400, exit: 400 } }, { children: jsx_runtime_1.jsx("div", __assign({ className: "fixed z-50 w-full h-full top-1/2 left-1/2 md:h-auto", style: { maxHeight: isMobile ? undefined : "calc(100vh - 128px)", maxWidth: maxWidth } }, { children: jsx_runtime_1.jsxs("div", __assign({ className: "py-10 md:py-8 px-4 md:px-8 bg-white md:rounded-lg h-full md:h-auto cursor-auto shadow-xl overflow-y-auto", style: {
                        ...
                        } }, { children: [loading ? (jsx_runtime_1.jsx("span", __assign({ className: "absolute flex top-1/2 transform -translate-y-1/2" }, { children: jsx_runtime_1.jsx(Purple_1.SpinnerPurple, {}, void 0) }), void 0)) : (jsx_runtime_1.jsx("div", { children: children }, void 0)),
                            renderFixedBottom && (jsx_runtime_1.jsx("div", __assign({ ref: fixedBottomRef, className: "absolute bottom-0 left-0 w-full px-4 py-3 bg-gray-100 border-t border-gray-200 md:px-8 md:py-4 md:rounded-b-lg" }, { children: renderFixedBottom() }), void 0)),
                            jsx_runtime_1.jsx(White_2.IconButtonWhite, { className: "absolute right-4 md:-right-5 md:-top-5", iconName: "FiX", onClick: function () {
                                    setVisible(false);
                                    onRequestClose && onRequestClose();
                                    ...
                                    : undefined }, void 0)] }), void 0) }), void 0) }), void 0)] }, void 0));
};
