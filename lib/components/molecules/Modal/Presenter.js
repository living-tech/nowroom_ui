...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [!isMobile && (jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
            ...
            jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                ...
                }, in: visible, timeout: { enter: 400, exit: 400 } }, { children: jsx_runtime_1.jsx("div", __assign({ className: "fixed z-50 w-full h-full top-1/2 left-1/2 md:h-auto", style: { maxHeight: isMobile ? undefined : "calc(100vh - 128px)", maxWidth: maxWidth } }, { children: jsx_runtime_1.jsxs("div", __assign({ className: "py-10 md:py-8 bg-white md:rounded-lg h-full md:h-auto cursor-auto shadow-xl overflow-y-auto " + paddingHorizontalClass, style: {
