...
var Presenter = function (_a) {
    ...
    var _j = react_1.useState(false), visible = _j[0], setVisible = _j[1];
    var _k = react_1.useState(0), fixedBottomHeight = _k[0], setFixedBottomHeight = _k[1];
    ...
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                    ...
                    exitActive: Modal_module_scss_1.default.ModalExitActive,
                        ...
                        setVisible(false);
                        onRequestClose && onRequestClose();
                    }, style: { zIndex: zIndex } }, { children: jsx_runtime_1.jsxs("div", __assign({ className: "items-center hidden md:flex" }, { children: [jsx_runtime_1.jsx(White_3.LabelTextWhite, { children: "ESC" }, void 0),
            ...
            jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                ...
                }, in: visible, timeout: { enter: 400, exit: 400 } }, { children: jsx_runtime_1.jsx("div", __assign({ className: "fixed top-1/2 left-1/2 " + modalSizeClass + " " + ((_b = props.className) !== null && _b !== void 0 ? _b : "") + " " + index_module_scss_1.default.isGreatterthanMaxWidth, "data-greatterthan": windowWidth <= maxWidth, style: {
                        maxWidth: maxWidth,
                        minHeight: loading ? 200 : undefined,
                        zIndex: zIndex + 1,
                    } }, { children: jsx_runtime_1.jsxs("div", __assign({ className: "transition-all ease-out duration-200 bg-white md:rounded-lg cursor-auto shadow-xl overflow-y-auto " + modalSizeClass + " " + paddingHorizontalClass + " " + paddingVerticalClass + " " + index_module_scss_1.default.isGreatterthanMaxWidth + " " + index_module_scss_1.default.fixedbottomheightMDMB, "data-closebuttonposition": closeButtonPosition, "data-greatterthan": windowWidth <= maxWidth, "data-paddingvertical": paddingVertical, style: {
                            maxWidth: maxWidth,
                            minHeight: loading ? 200 : undefined,
                        } }, { children: [loading ? (jsx_runtime_1.jsx("span", __assign({ className: "absolute flex top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2" }, { children: jsx_runtime_1.jsx(Purple_1.SpinnerPurple, {}, void 0) }), void 0)) : (jsx_runtime_1.jsx(jsx_runtime_1.Fragment, { children: jsx_runtime_1.jsx("div", { children: children }, void 0) }, void 0)),
                            ...
                            jsx_runtime_1.jsx(White_2.IconButtonWhite, { className: "right-4 md:-right-5 md:-top-5 test123 " + index_module_scss_1.default.IconButtonWhiteStyle, "data-closebuttonposition": closeButtonPosition, "data-fixedbottomheight": fixedBottomHeight, iconName: "FiX", onClick: function () {
                                    setVisible(false);
                                    onRequestClose && onRequestClose();
