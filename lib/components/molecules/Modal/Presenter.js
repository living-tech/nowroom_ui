...
var Presenter = function (_a) {
    ...
    var _k = utils_1.useBreakPoints(), isDesktop = _k.isDesktop, isMobile = _k.isMobile;
    var windowWidth = window_size_1.useWindowWidth();
    var _l = react_1.useState(false), visible = _l[0], setVisible = _l[1];
    var _m = react_1.useState(0), fixedBottomHeight = _m[0], setFixedBottomHeight = _m[1];
    ...
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                ...
                }, in: visible, timeout: 400 }, { children: jsx_runtime_1.jsx("div", __assign({ className: "fixed top-0 left-0 w-full h-full p-4 bg-overlay " + (disabledClose ? "" : "cursor-pointer"), onClick: function () {
                        if (disabledClose) {
                            return;
                        }
                        setVisible(false);
                        onRequestClose && onRequestClose();
                    }, style: { zIndex: zIndex } }, { children: !isMobile && !disabledClose && (jsx_runtime_1.jsxs("div", __assign({ className: "flex items-center" }, { children: [jsx_runtime_1.jsx(White_3.LabelTextWhite, { children: "ESC" }, void 0),
            ...
            jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                    ...
                    exitActive: Modal_module_scss_1.default.ModalInnerExitActive,
                }, in: visible, timeout: { enter: 400, exit: 400 } }, { children: jsx_runtime_1.jsx("div", __assign({ className: "fixed top-1/2 left-1/2 " + modalSizeClass + " " + ((_b = props.className) !== null && _b !== void 0 ? _b : ""), style: {
                        ...
                        zIndex: zIndex + 1,
                            ...
                            !disabledClose && (jsx_runtime_1.jsx(White_2.IconButtonWhite, { className: "right-4 md:-right-5 md:-top-5", iconName: "FiX", onClick: function () {
                                    setVisible(false);
                                    onRequestClose && onRequestClose();
