...
var Presenter = function (_a) {
    var children = _a.children, _b = _a.escLabel, escLabel = _b === void 0 ? "を押して閉じる" : _b, isVisible = _a.isVisible, loading = _a.loading, _c = _a.maxWidth, maxWidth = _c === void 0 ? 400 : _c, onRequestClose = _a.onRequestClose, props = __rest(_a, ["children", "escLabel", "isVisible", "loading", "maxWidth", "onRequestClose"]);
    ...
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                ...
                }, in: visible, timeout: 400 }, { children: jsx_runtime_1.jsx("div", __assign({ className: "fixed top-0 left-0 z-10 w-full h-full p-4 cursor-pointer bg-overlay", onClick: function () {
                        setVisible(false);
                        onRequestClose && onRequestClose();
            ...
            jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                ...
                }, in: visible, timeout: { enter: 400, exit: 400 } }, { children: jsx_runtime_1.jsxs("div", __assign({ className: "fixed top-1/2 left-1/2 z-20 w-full p-8 bg-white rounded-lg cursor-auto shadow-xl", style: { maxWidth: maxWidth } }, { children: [loading ? (jsx_runtime_1.jsx("span", __assign({ className: "absolute flex top-1/2 transform -translate-y-1/2" }, { children: jsx_runtime_1.jsx(Purple_1.SpinnerPurple, {}, void 0) }), void 0)) : (jsx_runtime_1.jsx("div", { children: children }, void 0)),
