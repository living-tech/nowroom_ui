...
var Presenter = function (_a) {
    var children = _a.children, isVisible = _a.isVisible, loading = _a.loading, _b = _a.maxWidth, maxWidth = _b === void 0 ? 400 : _b, onRequestClose = _a.onRequestClose, props = __rest(_a, ["children", "isVisible", "loading", "maxWidth", "onRequestClose"]);
    ...
    return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                    enter: Modal_module_css_1.default.ModalEnter,
                    enterActive: Modal_module_css_1.default.ModalEnterActive,
                    exit: Modal_module_css_1.default.ModalExit,
                    exitActive: Modal_module_css_1.default.ModalExitActive,
            ...
            jsx_runtime_1.jsx(react_transition_group_1.CSSTransition, __assign({ unmountOnExit: true, classNames: {
                    appear: Modal_module_css_1.default.ModalInnerAppear,
                    enter: Modal_module_css_1.default.ModalInnerEnter,
                    enterActive: Modal_module_css_1.default.ModalInnerEnterActive,
                    enterDone: Modal_module_css_1.default.ModalInnerEnterDone,
                    exit: Modal_module_css_1.default.ModalInnerExit,
                    exitActive: Modal_module_css_1.default.ModalInnerExitActive,
                }, in: visible, timeout: { enter: 400, exit: 400 } }, { children: jsx_runtime_1.jsxs("div", __assign({ className: "fixed top-1/2 left-1/2 z-20 w-full p-8 bg-white rounded-lg cursor-auto shadow-xl", style: { maxWidth: maxWidth } }, { children: [loading ? (jsx_runtime_1.jsx("span", __assign({ className: "top-1/2 absolute flex transform -translate-y-1/2" }, { children: jsx_runtime_1.jsx(Purple_1.SpinnerPurple, {}, void 0) }), void 0)) : (jsx_runtime_1.jsx("div", { children: children }, void 0)),
