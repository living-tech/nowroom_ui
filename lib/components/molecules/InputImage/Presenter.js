...
var Presenter = function (_a) {
    var any = _a.any, className = _a.className, id = _a.id, imageUrls = _a.imageUrls, label = _a.label, name = _a.name, onFileChange = _a.onFileChange, onGalleryClick = _a.onGalleryClick, onHandleDrop = _a.onHandleDrop, onImageDeleteClick = _a.onImageDeleteClick, style = _a.style, props = __rest(_a, ["any", "className", "id", "imageUrls", "label", "name", "onFileChange", "onGalleryClick", "onHandleDrop", "onImageDeleteClick", "style"]);
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, props, { children: [label && (jsx_runtime_1.jsxs("label", __assign({ className: "block mb-3 text-sm font-bold text-gray-700 cursor-pointer", htmlFor: id }, { children: [label, any && (jsx_runtime_1.jsx(MediumGray02_2.TextMediumGray02, __assign({ className: "ml-3", size: "sm", tag: "span" }, { children: t("任意") }), void 0))] }), void 0)),
            (imageUrls === null || imageUrls === void 0 ? void 0 : imageUrls.length) ? (jsx_runtime_1.jsx("div", __assign({ className: "mb-4 space-x-3" }, { children: imageUrls.map(function (imageUrl, index) { return (jsx_runtime_1.jsxs("div", __assign({ className: "relative inline-block", style: { height: 118, verticalAlign: "bottom", width: 118 } }, { children: [jsx_runtime_1.jsx("img", { alt: String(index), className: "object-cover rounded", loading: "lazy", src: imageUrl, style: { height: 118, width: 118 } }, void 0),
                        jsx_runtime_1.jsx(White_2.IconButtonWhite, { className: "absolute", iconName: "FiX", onClick: function () { return onImageDeleteClick && onImageDeleteClick(imageUrl, index); }, radius: true, shadow: false, size: "sm", style: {
                                right: 4,
                                top: 4,
            ...
            jsx_runtime_1.jsx("div", __assign({ onDragLeave: handleDragLeave, onDragOver: handleDragOver, onDrop: handleDrop }, { children: jsx_runtime_1.jsxs("div", __assign({ className: "flex flex-col justify-center px-32 py-8 rounded-md " + borderClass }, { children: [jsx_runtime_1.jsxs("div", __assign({ className: "flex justify-center items-center" }, { children: [jsx_runtime_1.jsx(MediumGray02_1.IconMediumGray02, { name: "FiImage" }, void 0),
                                jsx_runtime_1.jsx(MediumGray02_2.TextMediumGray02, __assign({ className: "ml-3", size: "sm", weight: "bold" }, { children: t("ドラッグ＆ドロップまたはファイル選択") }), void 0)] }), void 0),
                        jsx_runtime_1.jsxs("div", __assign({ className: "flex justify-center mt-4 space-x-3" }, { children: [onGalleryClick && (jsx_runtime_1.jsx(White_1.ButtonWhite, __assign({ onClick: onGalleryClick, size: "sm" }, { children: t("ギャラリーから選択") }), void 0)),
                                jsx_runtime_1.jsx(Purple_1.ButtonPurple, __assign({ padding: false, size: "sm" }, { children: jsx_runtime_1.jsxs("label", __assign({ className: "py-2.5 px-8 cursor-pointer", htmlFor: id }, { children: [t("ファイル選択"), jsx_runtime_1.jsx("input", { ref: inputRef, accept: "image/*", className: "sr-only", id: id, multiple: true, name: name, onChange: onFileChange, type: "file" }, void 0)] }), void 0) }), void 0)] }), void 0)] }), void 0) }), void 0)] }), void 0));
};
