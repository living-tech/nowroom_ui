...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: "" + className, id: id, style: style }, props, { children: [(label || any || require) && (jsx_runtime_1.jsxs("label", __assign({ className: "block mb-3 text-sm font-bold text-gray-700" }, { children: [label && label, any && (jsx_runtime_1.jsx(MediumGray02_1.TextMediumGray02, __assign({ className: "ml-3", size: "sm", tag: "span" }, { children: anyLabel }), void 0)),
            ...
            jsx_runtime_1.jsx("div", __assign({ className: variants({ gap_size: cvaVariants.gap_size, grid_cols: cvaVariants.grid_cols }) }, { children: items.map(function (item) { return (jsx_runtime_1.jsx(Default_1.InputRadio, { createRef: createRef, item: item, name: name, onChange: onChange, size: size }, "radio-" + item.value)); }) }), void 0),
