...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: "flex flex-col rounded-4xl relative overflow-x-hidden border-4 border-black " + className, style: __assign({ boxShadow: "0px 1px 3px rgba(0, 0, 0, 0.04), 0px 4px 8px rgba(30, 29, 37, 0.08)", height: layouts_1.iPhoneMockHeight, width: layouts_1.iPhoneMockWidth }, style) }, { children: [jsx_runtime_1.jsx("span", { className: "left-1/2 rounded-b-xl absolute top-0 inline-block transform -translate-x-1/2 bg-black", style: {
                    height: 20,
                    width: 180,
                } }, void 0),
