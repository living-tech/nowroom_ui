...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: "flex flex-col rounded-4xl relative overflow-x-hidden border-4 border-black " + className, style: __assign({ boxShadow: "0px 1px 3px rgba(0, 0, 0, 0.04), 0px 4px 8px rgba(30, 29, 37, 0.08)", height: constnats_1.iPhoneMockHeight, width: constnats_1.iPhoneMockWidth }, style) }, { children: [jsx_runtime_1.jsx("span", { className: "absolute top-0 inline-block bg-black left-1/2 rounded-b-xl transform -translate-x-1/2", style: {
                    height: 20,
                    width: 180,
                } }, void 0),
            jsx_runtime_1.jsx("span", { className: "absolute inline-block bg-gray-700 left-1/2 rounded-xl transform -translate-x-1/2", style: {
                    height: 4,
                    top: 8,
                    width: 50,
                } }, void 0),
