...
var Presenter = function (_a) {
    var _b = _a.id, id = _b === void 0 ? uuid : _b, _c = _a.className, className = _c === void 0 ? "" : _c, items = _a.items, _d = _a.panelsContainerClassName, panelsContainerClassName = _d === void 0 ? "" : _d, panelsContainerStyle = _a.panelsContainerStyle, style = _a.style, _e = _a.tabContainerClassName, tabContainerClassName = _e === void 0 ? "" : _e, tabContainerStyle = _a.tabContainerStyle, tabSize = _a.tabSize, _f = _a.tabsContainerClassName, tabsContainerClassName = _f === void 0 ? "" : _f, tabsContainerStyle = _a.tabsContainerStyle, _g = _a.tabsUnderLine, tabsUnderLine = _g === void 0 ? true : _g, _h = _a.tabsWidth, tabsWidth = _h === void 0 ? "full" : _h;
    var panelRef = react_1.useRef(null);
    var _j = react_1.useState(0), activeIndex = _j[0], setActiveIndex = _j[1];
    var _k = react_1.useState(0), containerWidth = _k[0], setContainerWidth = _k[1];
    var _l = react_1.useState(null), borderStyle = _l[0], setBorderStyle = _l[1];
    var _m = react_1.useState(null), hoverTab = _m[0], setHoverTab = _m[1];
    var tabDisplayClass = "";
    switch (tabsWidth) {
        case "full":
    ...
    react_1.useEffect(function () {
        ...
        var targetElement = document.getElementById(id + "-tab-" + targetIndex);
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, { children: [jsx_runtime_1.jsx(react_measure_1.default, __assign({ bounds: true, onResize: function (contentRect) {
                    ...
                    return (jsx_runtime_1.jsxs("div", __assign({ ref: measureRef, className: "relative" }, { children: [jsx_runtime_1.jsx("ul", __assign({ className: tabDisplayClass + " " + tabsContainerClassName, id: id, style: tabsContainerStyle }, { children: items.map(function (item, index) { return (jsx_runtime_1.jsx(Default_1.Tab, { active: activeIndex === index, className: tabContainerClassName, id: id + "-tab-" + index, index: index, label: item.label, onClick: onTabClick, onTabMouseEnter: onTabMouseEnter, onTabMouseLeave: onTabMouseLeave, size: tabSize, style: tabContainerStyle, tabUnderLine: tabsUnderLine }, index)); }) }), void 0),
