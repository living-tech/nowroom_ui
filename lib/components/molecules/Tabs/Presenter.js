...
exports.Presenter = react_1.memo(function (_a) {
    ...
    var onTabMouseEnter = react_1.useCallback(function (index) {
        setHoverTab(index);
    }, []);
    var onTabMouseLeave = react_1.useCallback(function () {
        setHoverTab(null);
    }, []);
    var onTabClick = react_1.useCallback(function (index) {
