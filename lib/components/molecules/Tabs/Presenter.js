...
var Presenter = function (_a) {
    ...
    var _m = react_1.useState(0), containerWidth = _m[0], setContainerWidth = _m[1];
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, { children: [jsx_runtime_1.jsx(react_measure_1.default, __assign({ bounds: true, onResize: function (contentRect) {
                    ...
                    return (jsx_runtime_1.jsx("div", __assign({ ref: measureRef, className: "relative " + tabsPositionClass }, { children: jsx_runtime_1.jsxs("div", __assign({ className: "relative" }, { children: [jsx_runtime_1.jsx("ul", __assign({ className: tabDisplayClass + " " + tabsContainerClassName, id: id, style: tabsContainerStyle }, { children: items.map(function (item, index) { return (jsx_runtime_1.jsx(Default_1.Tab, { active: activeIndex === index, className: tabContainerClassName, id: id + "-" + index, index: index, label: item.label, onClick: onTabClick, onTabMouseEnter: onTabMouseEnter, onTabMouseLeave: onTabMouseLeave, size: tabSize, style: tabContainerStyle, tabUnderLine: tabsUnderLine }, index)); }) }), void 0),
