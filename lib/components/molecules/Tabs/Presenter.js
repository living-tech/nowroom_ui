...
var Presenter = function (_a) {
    ...
    var _g = react_1.useState(0), containerWidth = _g[0], setContainerWidth = _g[1];
    var _h = react_1.useState(null), borderStyle = _h[0], setBorderStyle = _h[1];
    var _j = react_1.useState(null), hoverTab = _j[0], setHoverTab = _j[1];
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, { children: [jsx_runtime_1.jsx(react_measure_1.default, __assign({ bounds: true, onResize: function (contentRect) {
                    ...
                    return (jsx_runtime_1.jsxs("div", __assign({ ref: measureRef, className: "relative" }, { children: [jsx_runtime_1.jsx("ul", __assign({ className: "flex " + tabsContainerClassName, id: "tabs", style: tabsContainerStyle }, { children: items.map(function (item, index) { return (jsx_runtime_1.jsx(Default_1.Tab, { active: activeIndex === index, className: tabContainerClassName, id: "tab-" + index, index: index, label: item.label, onClick: onTabClick, onTabMouseEnter: onTabMouseEnter, onTabMouseLeave: onTabMouseLeave, size: tabSize, style: tabContainerStyle }, index)); }) }), void 0),
