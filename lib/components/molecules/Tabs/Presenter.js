...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, { children: [jsx_runtime_1.jsx("p", { children: "AAAAAAAAAAAAAAAAAAA" }, void 0),
            true ? (jsx_runtime_1.jsx("div", { children: "ABC" }, void 0)) : (jsx_runtime_1.jsx(react_measure_1.default, __assign({ bounds: true, onResize: function (contentRect) {
                    var _a;
                    ...
                    return (jsx_runtime_1.jsx("div", __assign({ ref: measureRef, className: "relative abc " + tabsPositionClass }, { children: jsx_runtime_1.jsxs("ul", __assign({ className: "relative " + tabDisplayClass + " " + tabsContainerClassName, id: id, style: tabsContainerStyle }, { children: [items.map(function (item, index) {
                                    var _a;
                                    return (jsx_runtime_1.jsx(Default_1.Tab, { active: activeIndex === index, className: tabContainerClassName, id: id + "-" + index, index: index, label: (_a = item.label) !== null && _a !== void 0 ? _a : "", onClick: onTabClick, onTabMouseEnter: onTabMouseEnter, onTabMouseLeave: onTabMouseLeave, size: tabSize, style: tabContainerStyle, tabUnderLine: tabsUnderLine }, index));
                                }),
