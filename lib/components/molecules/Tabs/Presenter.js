...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, { children: [jsx_runtime_1.jsxs("div", __assign({ className: "relative" }, { children: [jsx_runtime_1.jsx(react_measure_1.default, __assign({ bounds: true, onResize: function (contentRect) {
            ...
            jsx_runtime_1.jsx("div", __assign({ ref: panelRef, className: "w-full overflow-x-hidden whitespace-nowrap" }, { children: items.map(function (item, index) { return (jsx_runtime_1.jsx("div", __assign({ className: "inline-block w-full align-top" }, { children: item.renderPanel() }), index)); }) }), void 0)] }), void 0));
};
