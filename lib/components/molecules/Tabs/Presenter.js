...
var Presenter = function (_a) {
    ...
    var _q = react_1.useState(false), isClicked = _q[0], setIsClicked = _q[1];
    var tabDisplayClass = "";
    switch (tabsWidth) {
        case "full":
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, { children: [jsx_runtime_1.jsx(react_measure_1.default, __assign({ bounds: true, onResize: function (contentRect) {
                    ...
                    return (jsx_runtime_1.jsx("div", __assign({ ref: measureRef, className: "relative " + tabsPositionClass }, { children: jsx_runtime_1.jsxs("ul", __assign({ className: "relative " + tabDisplayClass + " " + tabsContainerClassName, id: id, style: tabsContainerStyle }, { children: [items.map(function (item, index) { return (jsx_runtime_1.jsx(Default_1.Tab, { active: activeIndex === index, className: tabContainerClassName, id: id + "-" + index, index: index, label: item.label, onClick: onTabClick, onTabMouseEnter: onTabMouseEnter, onTabMouseLeave: onTabMouseLeave, size: tabSize, style: tabContainerStyle, tabUnderLine: tabsUnderLine }, index)); }),
            ...
            jsx_runtime_1.jsx("div", __assign({ ref: panelRef, className: "w-full overflow-x-hidden whitespace-nowrap " + panelsContainerClassName, style: panelsContainerStyle }, { children: isClicked ? (items.map(function (item, index) { return (jsx_runtime_1.jsx("div", __assign({ className: "inline-block w-full align-top" }, { children: item.renderPanel() }), index)); })) : (jsx_runtime_1.jsx("div", __assign({ className: "inline-block w-full align-top" }, { children: items[activeIndex].renderPanel() }), void 0)) }), void 0)] }), void 0));
};
