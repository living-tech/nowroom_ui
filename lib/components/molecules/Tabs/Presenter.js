...
var Presenter = function (_a) {
    var _b = _a.id, id = _b === void 0 ? uuid : _b, _c = _a.className, className = _c === void 0 ? "" : _c, items = _a.items, _d = _a.panelsContainerClassName, panelsContainerClassName = _d === void 0 ? "" : _d, panelsContainerStyle = _a.panelsContainerStyle, style = _a.style, _e = _a.tabContainerClassName, tabContainerClassName = _e === void 0 ? "" : _e, tabContainerStyle = _a.tabContainerStyle, _f = _a.tabsPosition, tabsPosition = _f === void 0 ? "left" : _f, tabSize = _a.tabSize, _g = _a.tabsContainerClassName, tabsContainerClassName = _g === void 0 ? "" : _g, tabsContainerStyle = _a.tabsContainerStyle, _h = _a.tabsUnderLine, tabsUnderLine = _h === void 0 ? true : _h, _j = _a.tabsWidth, tabsWidth = _j === void 0 ? "full" : _j;
    var panelRef = react_1.useRef(null);
    var _k = react_1.useState(0), activeIndex = _k[0], setActiveIndex = _k[1];
    var _l = react_1.useState(0), containerWidth = _l[0], setContainerWidth = _l[1];
    var _m = react_1.useState(null), borderStyle = _m[0], setBorderStyle = _m[1];
    var _o = react_1.useState(null), hoverTab = _o[0], setHoverTab = _o[1];
    var tabDisplayClass = "";
    switch (tabsWidth) {
        case "full":
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, { children: [jsx_runtime_1.jsx(react_measure_1.default, __assign({ bounds: true, onResize: function (contentRect) {
                    ...
                    return (jsx_runtime_1.jsxs("div", __assign({ ref: measureRef, className: "relative " + tabsPositionClass }, { children: [jsx_runtime_1.jsx("ul", __assign({ className: tabDisplayClass + " " + tabsContainerClassName, id: id, style: tabsContainerStyle }, { children: items.map(function (item, index) { return (jsx_runtime_1.jsx(Default_1.Tab, { active: activeIndex === index, className: tabContainerClassName, id: id + "-" + index, index: index, label: item.label, onClick: onTabClick, onTabMouseEnter: onTabMouseEnter, onTabMouseLeave: onTabMouseLeave, size: tabSize, style: tabContainerStyle, tabUnderLine: tabsUnderLine }, index)); }) }), void 0),
