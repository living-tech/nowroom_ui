...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: className, style: style }, { children: [1 === items.length && items[0].label === undefined ? (jsx_runtime_1.jsx(jsx_runtime_1.Fragment, {}, void 0)) : (jsx_runtime_1.jsx(react_measure_1.default, __assign({ bounds: true, onResize: function (contentRect) {
                    var _a;
