...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsx(react_paginate_1.default, { activeClassName: "active", breakClassName: "break-me", breakLabel: jsx_runtime_1.jsx(Default_1.Icon, { name: "FiMoreHorizontal", size: 20 }, void 0), containerClassName: "pagination " + className, initialPage: initialPage, marginPagesDisplayed: isMobile ? 1 : 2, nextLabel: jsx_runtime_1.jsxs("span", __assign({ className: "flex items-center" }, { children: [!isMobile && (jsx_runtime_1.jsx(Default_2.Text, __assign({ className: "mr-1", size: "sm", weight: "bold" }, { children: nextTextLabel }), void 0)),
            ...
            return onPageChange && onPageChange(selected);
