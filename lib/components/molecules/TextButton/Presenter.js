...
var Presenter = function (_a) {
    ...
    if (tag === "a") {
        return (jsx_runtime_1.jsx("a", __assign({ className: baseClass + " " + textSizeClass + " " + textColorClass + " " + weightClass + " " + blockClass + " " + className, href: href, style: style, target: target }, props, { children: jsx_runtime_1.jsx(Inner, {}, void 0) }), void 0));
    }
    else {
        return (jsx_runtime_1.jsx("button", __assign({ className: baseClass + " " + textSizeClass + " " + textColorClass + " " + weightClass + " " + blockClass + " " + className, disabled: disabled || loading, style: style, type: type }, props, { children: jsx_runtime_1.jsx(Inner, {}, void 0) }), void 0));
    }
};
