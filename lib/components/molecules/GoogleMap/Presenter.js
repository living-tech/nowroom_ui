...
var Presenter = function (_a) {
    ...
    var _c = react_1.useState(createMapOptions), mapOptionsState = _c[0], setMapOptions = _c[1];
    ...
    return (jsx_runtime_1.jsx("div", __assign({ className: "" + className, style: __assign({ height: height }, style) }, { children: jsx_runtime_1.jsx(google_map_react_1.default, __assign({ bootstrapURLKeys: {
                ...
                lat: latitude,
                lng: longitude,
            }, defaultZoom: 16, options: mapOptionsState }, { children: jsx_runtime_1.jsx(AnyReactComponent, __assign({ lat: latitude, lng: longitude }, { children: jsx_runtime_1.jsx(Default_1.MapPin, { style: { marginLeft: -27, marginTop: -76 } }, void 0) }), void 0) }), void 0) }), void 0));
};
