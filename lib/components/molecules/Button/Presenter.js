...
var Presenter = function (_a) {
    var _b = _a.block, block = _b === void 0 ? false : _b, children = _a.children, className = _a.className, _c = _a.color, color = _c === void 0 ? "purple" : _c, disabled = _a.disabled, href = _a.href, iconName = _a.iconName, _d = _a.iconPosition, iconPosition = _d === void 0 ? "left" : _d, loading = _a.loading, onClick = _a.onClick, _e = _a.padding, padding = _e === void 0 ? true : _e, _f = _a.shadow, shadow = _f === void 0 ? true : _f, _g = _a.size, size = _g === void 0 ? "md" : _g, style = _a.style, _h = _a.tag, tag = _h === void 0 ? "button" : _h, target = _a.target, _j = _a.type, type = _j === void 0 ? "button" : _j, _k = _a.visualType, visualType = _k === void 0 ? "fill" : _k, props = __rest(_a, ["block", "children", "className", "color", "disabled", "href", "iconName", "iconPosition", "loading", "onClick", "padding", "shadow", "size", "style", "tag", "target", "type", "visualType"]);
    ...
    if (tag === "a") {
        return (jsx_runtime_1.jsx("a", __assign({ className: baseClass + " " + sizeClass + " " + borderColorClass + " " + backgroundColorClass + " " + textColorClass + " " + blockClass + " " + shadowClass + " " + className, href: href, style: style, target: target }, props, { children: jsx_runtime_1.jsx(Inner, {}, void 0) }), void 0));
    }
    else {
        return (jsx_runtime_1.jsx("button", __assign({ className: baseClass + " " + sizeClass + " " + borderColorClass + " " + backgroundColorClass + " " + textColorClass + " " + blockClass + " " + shadowClass + " " + className, disabled: disabled || loading, onClick: onClick, style: style, type: type }, props, { children: jsx_runtime_1.jsx(Inner, {}, void 0) }), void 0));
    }
};
