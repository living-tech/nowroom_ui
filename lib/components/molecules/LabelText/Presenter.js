...
var Presenter = function (_a) {
    var children = _a.children, className = _a.className, _b = _a.color, color = _b === void 0 ? "purple" : _b, _c = _a.size, size = _c === void 0 ? "md" : _c, style = _a.style;
    ...
    return (jsx_runtime_1.jsx("div", __assign({ className: baseClass + " " + sizeClass + " " + backgroundColorClass + " " + borderColorClass + " " + className, style: style }, { children: jsx_runtime_1.jsx(Default_1.Text, __assign({ className: "leading-none", color: textColor, size: size === "md" ? "xs" : "xxs", tag: "span", weight: "bold" }, { children: children }), void 0) }), void 0));
};
