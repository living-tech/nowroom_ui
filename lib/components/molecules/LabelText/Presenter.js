...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsx("div", __assign({ className: baseClass + " " + cursorClass + " " + sizeClass + " " + fontSize + " " + backgroundColorClass + " " + backgroundColorHoverClass + " " + borderColorClass + " " + textColor + " " + borderColorHoverClass + " " + className, style: style }, { children: children }), void 0));
};
