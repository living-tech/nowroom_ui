...
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsx("div", __assign({ className: baseClass + " " + cursorClass + " " + sizeClass + " " + backgroundColorClass + " " + backgroundColorHoverClass + " " + borderColorClass + " " + borderColorHoverClass + "  " + className, style: style }, { children: jsx_runtime_1.jsx(Default_1.Text, __assign({ className: " leading-none", color: textColor, size: size === "md" ? "xs" : "xxs", style: { paddingTop: 1 }, tag: "span", weight: "bold" }, { children: children }), void 0) }), void 0));
};
