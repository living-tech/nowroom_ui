...
var LabelText_module_scss_1 = __importDefault(require("./LabelText.module.scss"));
var Presenter = function (_a) {
    ...
    return (jsx_runtime_1.jsx("div", __assign({ className: baseClass + " " + cursorClass + " " + fontSize + " " + backgroundColorClass + " " + backgroundColorHoverClass + " " + borderColorClass + " " + textColor + " " + borderColorHoverClass + " " + className + " " + LabelText_module_scss_1.default.divStyle, style: style }, { children: children }), void 0));
};
