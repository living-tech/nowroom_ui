...
var Presenter = function (_a) {
    var _b = _a.border, border = _b === void 0 ? true : _b, className = _a.className, _c = _a.color, color = _c === void 0 ? "transparent" : _c, disabled = _a.disabled, iconColor = _a.iconColor, iconName = _a.iconName, _d = _a.radius, radius = _d === void 0 ? false : _d, _e = _a.shadow, shadow = _e === void 0 ? true : _e, _f = _a.size, size = _f === void 0 ? "md" : _f, style = _a.style, _g = _a.visualType, visualType = _g === void 0 ? "fill" : _g, props = __rest(_a, ["border", "className", "color", "disabled", "iconColor", "iconName", "radius", "shadow", "size", "style", "visualType"]);
    ...
    return (jsx_runtime_1.jsx("button", __assign({ className: baseClass + " " + sizeClass + " " + borderRadiusClass + " " + borderColorClass + " " + backgroundColorClass + " " + iconColorClass + " " + shadowClass + " " + className, disabled: disabled, style: style, type: "button" }, props, { children: jsx_runtime_1.jsx(Default_1.Icon, { color: iconColor, name: iconName, size: iconSize }, void 0) }), void 0));
};
