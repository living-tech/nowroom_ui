...
var Presenter = function (_a) {
    ...
    var Inner = function () { return (jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, { children: [jsx_runtime_1.jsx(Default_1.Icon, { className: "" + loadingIconColorClass, color: iconColor, currentType: currentType, name: iconName, size: iconSize }, void 0),
