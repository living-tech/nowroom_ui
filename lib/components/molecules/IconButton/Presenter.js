...
var Presenter = function (_a) {
    var _b = _a.border, border = _b === void 0 ? true : _b, className = _a.className, _c = _a.color, color = _c === void 0 ? "transparent" : _c, currentType = _a.currentType, disabled = _a.disabled, href = _a.href, iconColor = _a.iconColor, iconName = _a.iconName, _d = _a.radius, radius = _d === void 0 ? false : _d, _e = _a.shadow, shadow = _e === void 0 ? true : _e, _f = _a.size, size = _f === void 0 ? "md" : _f, style = _a.style, _g = _a.tag, tag = _g === void 0 ? "button" : _g, target = _a.target, _h = _a.visualType, visualType = _h === void 0 ? "fill" : _h, props = __rest(_a, ["border", "className", "color", "currentType", "disabled", "href", "iconColor", "iconName", "radius", "shadow", "size", "style", "tag", "target", "visualType"]);
    ...
    var Inner = function () { return jsx_runtime_1.jsx(Default_1.Icon, { color: iconColor, currentType: currentType, name: iconName, size: iconSize }, void 0); };
    if (tag === "a") {
