...
export var Presenter = function (_a) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("label", __assign({ className: "inline-flex items-center cursor-pointer " + className, style: style }, props, { children: [_jsx("input", { ref: createRef, checked: checked, className: inputClass, name: name, onChange: onChange, onClick: onClick, style: {
