...
export var Presenter = function (_a) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("label", __assign({ className: "inline-flex items-center cursor-pointer " + className, htmlFor: uuid, style: style }, props, { children: [_jsx("input", { ref: createRef, checked: checked, className: inputClass, id: uuid, name: name, onChange: handleChange, onClick: onClick, style: {
