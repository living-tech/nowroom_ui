...
export var Presenter = function (_a) {
    ...
    return (_jsxs("div", __assign({ className: containerBaseClass + " " + containerClass + " " + styles.Container + " " + className, onClick: function () { return onClick && onClick(item); }, style: style }, props, { children: [_jsx(Text, __assign({ className: "relative flex-initial text-current transition-all duration-200 ease-out", size: "xs", style: { top: 1 } }, { children: item.label }), void 0),
            _jsx("div", __assign({ className: "transition-all ease-out duration-200 flex rounded-full w-5 h-5 " + (color === "purple" ? "bg-white" : "bg-purple") + " items-center justify-center ml-2.5 " + (color === "purple" ? styles.circleSelected : styles.circleUnselected) }, { children: iconType === "selected" ? (_jsxs("svg", __assign({ className: "transition-all ease-out duration-200", height: "14px", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3", viewBox: "0 0 24 24", width: "14px", xmlns: "http://www.w3.org/2000/svg" }, { children: [_jsx("line", { x1: "18", x2: "6", y1: "6", y2: "18" }, void 0),
                        _jsx("line", { x1: "6", x2: "18", y1: "6", y2: "18" }, void 0)] }), void 0)) : (_jsxs("svg", __assign({ className: "transition-all ease-out duration-200", height: "14px", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3", viewBox: "0 0 24 24", width: "14px", xmlns: "http://www.w3.org/2000/svg" }, { children: [_jsx("line", { x1: "12", x2: "12", y1: "6", y2: "18" }, void 0),
