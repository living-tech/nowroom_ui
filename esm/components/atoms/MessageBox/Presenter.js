...
export var Presenter = function (_a) {
    ...
    return (_jsx("div", __assign({ className: borderClass + " " + borderColorClass + " " + backgroundColorClass + " " + sizeClass + " " + baseClass + " " + className, style: style }, { children: children }), void 0));
};
