...
export var Presenter = function (_a) {
    ...
    return (_jsx(ReactPaginate, { activeClassName: "active", breakClassName: "break-me", breakLabel: _jsx(Icon, { name: "FiMoreHorizontal", size: 20 }, void 0), containerClassName: "pagination " + className, disableInitialCallback: true, initialPage: initialPage - 1, marginPagesDisplayed: marginPagesDisplayed ? marginPagesDisplayed : displayedNum, nextClassName: withoutArrow ? "hidden" : undefined, nextLabel: _jsxs("span", __assign({ className: "flex items-center" }, { children: [!isMobile && (_jsx(Text, __assign({ className: "mr-1", size: "sm", weight: "bold" }, { children: nextTextLabel }), void 0)),
