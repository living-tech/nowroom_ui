...
export var Presenter = function (_a) {
    ...
    return (_jsxs("div", __assign({ className: "" + className, id: id, style: style }, props, { children: [(label || any || require) && (_jsxs("label", __assign({ className: "block mb-3 text-sm font-bold text-gray-700" }, { children: [label && label, any && (_jsx(TextMediumGray02, __assign({ className: "ml-3", size: "sm", tag: "span" }, { children: anyLabel }), void 0)),
            ...
            _jsx("div", __assign({ className: variants({ gap_size: cvaVariants === null || cvaVariants === void 0 ? void 0 : cvaVariants.gap_size, grid_cols: cvaVariants === null || cvaVariants === void 0 ? void 0 : cvaVariants.grid_cols }) }, { children: items.map(function (item) { return (_jsx(InputRadio, { createRef: createRef, item: item, name: name, onChange: onChange, size: size }, "radio-" + item.value)); }) }), void 0),
